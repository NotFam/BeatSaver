...
<script src='https://www.google.com/recaptcha/api.js'></script>
   <div class="container">
      <form class="form-signin" method="POST">
        ...
        <ul>
                <li>An email is dispatched to the provided email to set your password, it will be coming from no-reply@beatsaver.com with the Subject: BeatSaver: New Password <b>Hotmail has known issues not accepting my mail</b></li>
